...
class ChapterService {
  ...
  static Future<ChapterViewModel> chapterContentFetch({
    ...
    String globalBibleID =
        Provider.of<BibleIDProvider>(context, listen: false).selectedBible;
    final localData = await _dbHelper.fetchChapter(chapterID, globalBibleID);
    if (localData != null) {
      printStatement("Not called api");
      return localData;
    }

    printStatement("Called api");
    ...
    final chapter = ChapterViewModel.fromJson(data);

    await _dbHelper.insertChapter(chapter);
